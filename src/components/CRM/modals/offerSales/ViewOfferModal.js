...
export default function ViewOfferModal() {
  ...
  if (selectedOffer) {
    return (
      <Dialog
        open={isViewOfferModalOpen}
        onOpenChange={setIsViewOfferModalOpen}
      >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Badge
                    className={
                      selectedOffer.offerStatus === 0
                        ? "bg-green-500"
                        : selectedOffer.offerStatus === 1
                        ? "bg-yellow-500"
                        : "bg-red-500"
                    }
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">
                      KDV DAHİL
                      {selectedOffer.vatIncluded === !null &&
                      selectedOffer.vatIncluded === 1
                        ? "DİR"
                        : " DEĞİLDİR"}
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p>
                      {selectedOffer.discountValue ? (
                        <CurrencyFormatter
                          amount={selectedOffer.finalAmount}
                          currency={selectedOffer.currency}
                        />
                      ) : (
                        <CurrencyFormatter
